...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search" placeholder="Tìm sách của Cải ở đây..." class="box">
...
<section class="products" style="padding-top: 0;">
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         <img src="assets/uploads/<?php echo $fetch_product['image']; ?>" alt="" class="image">
      ...
      <?php
               ...
               echo '<p class="emptysearch">Không tìm thấy sách phù hợp.</p>';
            }
         }else{
            echo '<p class="emptysearch">Nhập tên sách để bắt đầu tìm kiếm.</p>';
         }
      ?>
   </div>
</section>
