...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <img src="assets/uploads/<?php echo $fetch_cart['image']; ?>" alt="">
         ...
         <div class="sub-total">Thành tiền: <span><?php echo number_format($sub_total, 0, ',', '.'); ?> VNĐ</span></div>
      </div>
      <?php
   ...
   <div class="load-more">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Xóa toàn bộ giỏ hàng?');">Xóa tất cả</a>
   </div>
